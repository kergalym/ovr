...
SRC_URI="https://bitbucket.org/MakeHuman/makehuman/get/$PV.zip https://bitbucket.org/MakeHuman/makehuman/downloads/assets_base_1_0b.zip"
LICENSE="GPL-3"
SLOT="0"
KEYWORDS="~x86 ~amd64"
IUSE="aqsis blender"
...
src_install() {
	...
	unzip ${DISTDIR}/assets_base_1_0b.zip -d ${D}/opt/makehuman/data/
}
