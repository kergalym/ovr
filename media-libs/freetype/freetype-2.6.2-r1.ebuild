...
INFINALITY_PATCH="03-infinality-2.6-2015.10.04"
...
SRC_URI="mirror://sourceforge/freetype/${P/_/}.tar.bz2
	...
	infinality? ( https://dev.gentoo.org/~polynomial-c/${INFINALITY_PATCH}.patch.xz )"
...
src_prepare() {
	...
	if use infinality; then
		epatch "${WORKDIR}/${INFINALITY_PATCH}.patch"
