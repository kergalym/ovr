...
src_install() {
	...
	# insinto "/etc/amd/"
    # doins "amdapfxx.blb"
	dodir "/opt/amdgpu-pro/lib64/"
	dodir "/opt/amdgpu-pro/lib/"
	dodir "/opt/amdgpu-pro/lib/x86_64-linux-gnu/"
	dodir "/opt/amdgpu-pro/lib/i386-linux-gnu/"
...
pkg_postinst() {
	...
	elog ""
	elog "and do on 64-bit systems"
	elog ""
	elog "   `ln -sv /usr/lib64/libdrm_amdgpu.so.1	/opt/amdgpu-pro/lib64/libdrm_amdgpu.so.1.0.0`"
	elog "   `ln -sv /usr/lib64/libdrm_amdgpu.so.1  /opt/amdgpu-pro/lib/x86_64-linux-gnu/libdrm_amdgpu.so.1.0.0`"
}
