...
inherit eutils linux-info pam autotools-utils versionator systemd
...
IUSE="+daemon debug pam static-libs +tools debug systemd"
...
DEPEND="
	...
	sys-devel/flex
	"
REQUIRED_USE="daemon? ( tools ) systemd "
...
pkg_postinst() {
	...
	elog "For systemd users enable 'cgconfig.service' and 'cgrules.service'."
}
