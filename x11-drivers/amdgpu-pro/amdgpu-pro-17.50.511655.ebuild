...
src_unpack() {
	...
	if use opengl ; then
		...
		if use abi_x86_32 ; then
			unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-amdgpu1_2.4.82-${PKG_REV}_i386.deb"
			unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-radeon1_2.4.82-${PKG_REV}_i386.deb"
	...
	if use gles2 ; then
		# Install GLES2
		unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libgles2-amdgpu_${PKG_VER_STRING}_amd64.deb"
		
		if use abi_x86_32 ; then
			unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libgles2-amdgpu_${PKG_VER_STRING}_i386.deb"
		fi
	fi
	...
	if use vdpau ; then
		# Install VDPAU
		unpack_deb "amdgpu-pro-${PKG_VER_STRING}/mesa-amdgpu-vdpau-drivers_17.2.4-${PKG_REV}_amd64.deb"
		
		if use abi_x86_32 ; then
			unpack_deb "amdgpu-pro-${PKG_VER_STRING}/mesa-amdgpu-vdpau-drivers_17.2.4-${PKG_REV}_i386.deb"
		fi
	fi
